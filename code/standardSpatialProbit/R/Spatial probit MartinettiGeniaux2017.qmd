...
```{r}
sams <- list(
  'A99_pastAvgW_uW_b97q4_s03q4_sample' <- readRDS("C:/Users/emi/OneDrive/UWA PhD/bankFailure/data/SAMS/A99_pastAvgW_uW_b97q4_s03q4_sample.rds")
...
```{r}
res1 <- ProbitSpatial::ProbitSpatialFit(formula = y ~ log(ActivoN) + C8Est_w+ CAR_IRR_3A6+ P_ROA+ P_DEP_ARS_RATE +
  P_LOANS_ARS_RATE_W+ APRSpNF_RATE_W+ APR_USD_RATE+ APR_RATE_W, 
                                data= X, 
