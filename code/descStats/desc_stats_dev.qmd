...
Descriptive statistics from the database, not the sample. 
...
### How many local-private banks failed?

```{r}
filter(fByQ, Quarter >= 1999.1 & Quarter <= 2001.3 & !is.na(N_FAIL))$N_FAIL %>%
  sum
```

## Survival plot

```{r survival_plot_private}
...
Baseline sample is A98_W98_B2L_nz_99FT01q3.rds. Also see `code/network/network_plot_dev.Rmd`

```{r}
sam <- readRDS('../../data/SAMS/A98_W98und_B2L_nz_99FT01q3.rds')
