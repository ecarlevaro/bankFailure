...
author: "Emi"
params:
  IDSAM: 'A98_W98unw_B2L_nz_99FT01q3'
output: 
  html_document:
    code_folding: hide
...
-   $W$ is `r if(SS$W.DIRECTED == TRUE) { print('DIRECTED')} else { print('UNdirected')}`

-   $W$ is `r if(SS$W.WEIGHTED == TRUE) { print('WEIghted') } else { print('UNweighted')}`
