...
```{r thisSample}
samsSpecs <- list('s1997q4' = c(samStart=1997.4, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1998q1' = c(samStart=1998.1, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1998q2' = c(samStart=1998.2, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1998q3' = c(samStart=1998.3, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1998q4' = c(samStart=1998.4, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1999q1' = c(samStart=1999.1, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1999q2' = c(samStart=1999.2, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1999q3' = c(samStart=1999.3, samEnd=2001.4, excludeStateOwn=TRUE),
                  's1999q4' = c(samStart=1999.4, samEnd=2001.4, excludeStateOwn=TRUE))
```
...
Are state-owned banks excluded? `r samsSpecs[[1]]['stateOwn']`
