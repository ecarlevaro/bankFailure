...
by IDENT: gen ActivoN_S_L4 = L4.ActivoN_S
label var ActivoN_S_L4 "Moving average last 4 previous quarters"
by IDENT: gen APRestamos_L4 = L4.APRestamos
label var APRestamos_L4 "Moving average last 4 previous quarters"
// ALl these vars are in percentage (%). I rescaled them in basis points. It avoids problems when computing the Hessian.
foreach varName of var    C8Est CAR_IRR_3A6_IMP P_ROA P_LOANS_ARS_RATE_IS_IMP APRSpNF_RATE_W APR_USD_RATE APR_RATE_W  {
	by IDENT: gen `varName'_L4 = L4.`varName'*100
	label var `varName'_L4 "Moving average last 4 previous quarters (bps)"
}

keep if tin(1998q4,2001q4)
//drop miss touse
...
save "C:\Users\emi.ABLE-22868\OneDrive\UWA PhD\bankFailure\data\SAMS\98q4_01q4_lag4_bps.dta", replace
